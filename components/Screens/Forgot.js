        ...
        <SafeAreaView>
            <ScrollView>
                <View style={styles.main}>
                    ...
                    <Text style={styles.Para}>Please enter the email address 
                    ...
                    <TouchableOpacity style={{
                        alignSelf: 'center', width: ('100%'), height: ('10%'), backgroundColor: '#F45CA5', borderRadius: 10,
                        marginTop: ('10%')
                    }}
                        onPress={onpress}
                    ...
                    <View style={{ flexDirection: 'row', marginTop: ('10%'), justifyContent: 'center' }}>
                        ...
                        >
                            <Text style={{ color: '#F45CA5', fontWeight: 'bold' }}> Back</Text>
                        </TouchableOpacity>
                    </View>
